...
$taskTriggerTime = [System.Environment]::GetEnvironmentVariable("clear_shadow_copies_time", "Machine")
if (-Not ($taskTriggerTime)) {$taskTriggerTime = "19:30"} # Default to 7:30 PM if there is no other schedule
